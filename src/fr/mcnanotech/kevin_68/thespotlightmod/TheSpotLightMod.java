...
@Mod(modid = TheSpotLightMod.MODID, name = "The SpotLight Mod", version = "@VERSION@", dependencies = "required-after:ffmtlibs", acceptableRemoteVersions = "*", acceptedMinecraftVersions = "[1.11]", updateJSON = "http://dl.mcnanotech.fr/kevin_68/TSM/version.json")
