...
@Mod(modid = TheSpotLightMod.MODID, name = "The SpotLight Mod", version = "@VERSION@", dependencies = "required-after:ffmtlibs;required-after:Forge@[11.14.4.1589,)", acceptableRemoteVersions = "*", acceptedMinecraftVersions = "1.8.8", updateJSON = "http://dl.mcnanotech.fr/kevin_68/TSM/version.json")
