...
public class GuiSpotLightDeleteConfig extends GuiContainer implements GuiListBase
{
	...
	public void initGui()
	{
		...
		buttonList.add(0, new GuiButton(0, x + 6, y + 117, 78, 20, I18n.format("container.spotlight.back")));
		buttonList.add(1, deleteButton = new GuiButton(1, x + 90, y + 117, 78, 20, EnumChatFormatting.RED + I18n.format("container.spotlight.delete")));
		buttonList.add(2, helpButton = new GuiBooleanButton(20, x + 180, y + 140, 20, 20, "?", false));
	...
	protected void actionPerformed(GuiButton guibutton)
	{
		...
		case 1:
		{
			...
			{
				PacketSender.send(EnumLaserInformations.COMMANDREMOVECONFIG, selected.getId());
			}
			break;
		}
		case 20:
		...
		default:
		{
			gList.actionPerformed(guibutton, buttonList);
		}
		}
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialRenderTick)
	{
		...
		if(helpButton.getIsActive())
		{
			...
			if(mouseY > y + 95 && mouseY < y + 115)
			{
				...
				{
					list = UtilSpotLight.formatedText(fontRendererObj, I18n.format("tutorial.spotlight.textures.prevpage"), mouseX, width, reversed);
				}

				if(mouseX > x + 149 && mouseX < x + 169)
				{
					list = UtilSpotLight.formatedText(fontRendererObj, I18n.format("tutorial.spotlight.textures.nextpage"), mouseX, width, reversed);
				}
			}

			if(mouseX > x + 6 && mouseX < x + 169 && mouseY > y + 17 && mouseY < y + 90)
			{
				list = UtilSpotLight.formatedText(fontRendererObj, I18n.format("tutorial.spotlight.configs.delete.slots"), mouseX, width, reversed);
			}
			...
			if(mouseY > y + 117 && mouseY < y + 137)
			{
				...
				{
					list = UtilSpotLight.formatedText(fontRendererObj, I18n.format("tutorial.spotlight.configs.delete.del"), mouseX, width, reversed);
				}
			}
	...
	protected void drawGuiContainerBackgroundLayer(float partialRenderTick, int mouseX, int mouseY)
	{
		...
		fontRendererObj.drawString(I18n.format("container.spotlight.desc", I18n.format("container.spotlight.delete")), x + 5, y + 8, 4210752);
	}
}