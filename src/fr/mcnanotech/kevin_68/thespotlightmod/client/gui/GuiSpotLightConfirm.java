...
public class GuiSpotLightConfirm extends GuiContainer
{
    ...
    protected void actionPerformed(GuiButton guibutton)
    {
        if(guibutton.id == 1)
        {
            if(this.guiopen == 0)
            {
                // SpotLightEntry entry = new SpotLightEntry(false, (byte)0,
                // (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, 0, (byte)0,
                // false, false, (byte)0, true, (byte)0, false, (byte)0,
                // (byte)0, 0, false, (byte)0, (byte)0, (byte)0, 0, false,
                // false, (byte)0, (byte)0, (byte)0, (byte)0);
                // PacketSender.sendSpotLightPacket(this.tile,
                // (Byte)this.tile.get(EnumLaserInformations.TIMELINELASTKEYSELECTED)
                // & 0xFF, entry);
                // this.tile.setKey((Byte)this.tile.get(EnumLaserInformations.TIMELINELASTKEYSELECTED)
                // & 0xFF, entry);
