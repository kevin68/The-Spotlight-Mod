...
//			PacketSender.send(EnumLaserInformations.TIMELINEENABLED, this.timeLineModeButton.isActive());
		}
...
//			PacketSender.send(EnumLaserInformations.TIMELINESMOOTH, this.smoothButton.isActive());
		}
