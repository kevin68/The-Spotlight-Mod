...
public class GuiSpotLightBeamSpec extends GuiContainer implements ISliderButton
{
	...
	public void initGui()
	{
		...
		this.buttonList.add(new GuiSliderButton(this, 0, x - 40, y - 20, 256, 20, I18n.format("container.spotlight.angle") + " 1 : " + tileSpotLight.getAngle1(), (tileSpotLight.getAngle1()) / 360.0F));
		this.buttonList.add(new GuiSliderButton(this, 1, x - 40, y + 2, 256, 20, I18n.format("container.spotlight.angle") + " 2 : " + (tileSpotLight.getAngle2() & 0xFF), (tileSpotLight.getAngle2() & 0xFF) / 180.0F));
		...
		this.buttonList.add(new GuiSliderButton(this, 4, x - 40, y + 48, 127, 20, I18n.format("container.spotlight.rotationspeed") + " : " + (tileSpotLight.getRotationSpeed() & 0xFF), (tileSpotLight.getRotationSpeed()) / 20.0F));
		...
		this.buttonList.add(axeButton = new GuiMultipleOptionButton(7, x + 146, y + 113, 70, 20, I18n.format("container.spotlight.axis") + " : ", new String[] {"y", "x", "z"}, (tileSpotLight.getAxe() & 0xFF)));
		this.buttonList.add(new GuiSliderButton(this, 11, x - 40, y + 70, 256, 20, I18n.format("container.spotlight.laserHeight") + " : " + tileSpotLight.getLaserHeight(), tileSpotLight.getLaserHeight() / 512.0F));
		...
		this.buttonList.add(new GuiSliderButton(this, 9, x - 40, y + 92, 127, 20, I18n.format("container.spotlight.sizeMain") + " : " + (tileSpotLight.getMainLaserSize() & 0xFF), (tileSpotLight.getMainLaserSize() & 0xFF) / 100.0F));
		this.buttonList.add(new GuiSliderButton(this, 10, x + 89, y + 92, 127, 20, I18n.format("container.spotlight.sizeSec") + " : " + (tileSpotLight.getSecLaserSize() & 0xFF), (tileSpotLight.getSecLaserSize() & 0xFF) / 100.0F));
