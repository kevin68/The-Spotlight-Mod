...
public class GuiSpotLightBeamAngles extends GuiContainer implements ISliderButton
{
                                                                           ...
                                                                           // help
    {
        ...
        // I18n.format("tutorial.spotlight.props.angle1"), mouseX, this.width,
        // reversed);
        // }
        // if(mouseY > y + 2 && mouseY < y + 22)
        // {
        // list = UtilSpotLight.formatedText(this.fontRendererObj,
        // I18n.format("tutorial.spotlight.props.angle2"), mouseX, this.width,
        // reversed);
        // }
        // if(mouseY > y + 68 && mouseY < y + 88)
        // {
        // list = UtilSpotLight.formatedText(this.fontRendererObj,
        // I18n.format("tutorial.spotlight.props.height"), mouseX, this.width,
        // reversed);
        // }
        // }
        //
        ...
        // {
        // list = UtilSpotLight.formatedText(this.fontRendererObj,
        // I18n.format("tutorial.spotlight.props.simple"), mouseX, this.width,
        // reversed);
        // }
        // }
        //
