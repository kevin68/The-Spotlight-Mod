...
public class GuiSpotLight extends GuiContainer
{
	...
	public void initGui()
	{
		...
		this.buttonList.add(this.timeButton = new GuiBooleanButton(4, x + 90, y + 66, 80, 20, I18n.format("container.spotlight.timeline"), I18n.format("container.spotlight.timeline"), (Boolean)this.tile.get(EnumLaserInformations.TIMELINEENABLED)));
		this.buttonList.add(this.textButton = new GuiBooleanButton(6, x + 5, y + 89, 80, 20, I18n.format("container.spotlight.textEnabled") + " " + I18n.format("container.spotlight.true"), I18n.format("container.spotlight.textEnabled") + " " + I18n.format("container.spotlight.false"), (Boolean)this.tile.get(EnumLaserInformations.TEXTENABLED)));
	...
	protected void actionPerformed(GuiButton guibutton)
	{
		...
		case 2:
		{
			this.mc.displayGuiScreen(new GuiSpotLightBeamSpec(this.invPlayer, this.tile, this.world));
			break;
		}
		case 3:
		{
		...
		case 4:
		{
			...
			PacketSender.send(EnumLaserInformations.TIMELINEENABLED, this.timeButton.getIsActive());
			break;
		}
		case 5:
		{
		...
		case 6:
		{
			...
			PacketSender.send(EnumLaserInformations.TEXTENABLED, this.textButton.getIsActive());
			break;
		}
		case 7:
		{
		...
		case 10:
		{
			this.mc.displayGuiScreen(new GuiSpotLightBeamSpec2(this.invPlayer, this.tile, this.world));
			break;
		}
		case 20:
		{
