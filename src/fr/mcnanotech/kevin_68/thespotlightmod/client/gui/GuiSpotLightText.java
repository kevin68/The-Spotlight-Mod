...
public class GuiSpotLightText extends GuiContainer implements ISliderButton
{
	...
	public void initGui()
	{
		...
		this.buttonList.add(new GuiSliderButton(this, 0, x - 40, y - 20, 256, 20, I18n.format("container.spotlight.red") + " : " + (tileSpotLight.getTxtRed() & 0xFF), (tileSpotLight.getTxtRed() & 0xFF) / 255.0F));
		this.buttonList.add(new GuiSliderButton(this, 1, x - 40, y + 2, 256, 20, I18n.format("container.spotlight.green") + " : " + (tileSpotLight.getTxtGreen() & 0xFF), (tileSpotLight.getTxtGreen() & 0xFF) / 255.0F));
		this.buttonList.add(new GuiSliderButton(this, 2, x - 40, y + 25, 256, 20, I18n.format("container.spotlight.blue") + " : " + (tileSpotLight.getTxtBlue() & 0xFF), (tileSpotLight.getTxtBlue() & 0xFF) / 255.0F));
		this.buttonList.add(new GuiSliderButton(this, 3, x - 40, y + 48, 256, 20, I18n.format("container.spotlight.angle") + " 1 : " + (tileSpotLight.getTxtAngle1()), (tileSpotLight.getTxtAngle1()) / 360.0F));
		...
		this.buttonList.add(new GuiSliderButton(this, 5, x - 40, y + 72, 127, 20, I18n.format("container.spotlight.rotationspeed") + " : " + (tileSpotLight.getTxtRotationSpeed() & 0xFF), (tileSpotLight.getTxtRotationSpeed()) / 20.0F));
