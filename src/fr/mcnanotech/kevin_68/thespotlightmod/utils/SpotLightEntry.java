...
public class SpotLightEntry
{
	...
	public void readFromNBT(NBTTagCompound nbtTagCompound)
	{
		...
		this.map.put(EnumLaserInformations.LASERGREEN, nbtTagCompound.getByte("green"));
		...
		this.map.put(EnumLaserInformations.TEXTROTATIONSPEED, nbtTagCompound.getByte("txtRotSpe"));
