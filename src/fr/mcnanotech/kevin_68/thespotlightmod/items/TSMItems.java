...
public class TSMItems
{
    ...
    {
        configSaver = new ItemConfigSaver().setUnlocalizedName("configsaver").setCreativeTab(TheSpotLightMod.tab).setMaxDamage(1).setTextureName(TheSpotLightMod.MODID + ":configsaver");
