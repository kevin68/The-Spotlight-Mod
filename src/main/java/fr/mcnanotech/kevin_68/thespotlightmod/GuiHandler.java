...
public class GuiHandler implements IGuiHandler
{
    ...
    public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z)
    {
        ...
        if(tileentity instanceof TileEntitySpotLight)
        {
            ...
            case 3:
            {
                return new ContainerSpotLight((TileEntitySpotLight)tileentity, player.inventory, 51, 186, true);
            }
            case 4:
            {
                return new ContainerSpotLight((TileEntitySpotLight)tileentity, player.inventory, false);
            }
            default:
            {
                return new ContainerSpotLight((TileEntitySpotLight)tileentity, player.inventory, true);
            }
            }
        }
        return null;
