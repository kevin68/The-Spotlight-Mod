...
public class TSMNetwork {
	...
	public static final SimpleChannel CHANNEL = NetworkRegistry.ChannelBuilder.named(new ResourceLocation(TheSpotLightMod.MOD_ID, "tsm")).networkProtocolVersion(() -> PROTOCOL_VERSION)
