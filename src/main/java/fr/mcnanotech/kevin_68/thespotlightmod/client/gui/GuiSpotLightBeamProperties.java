...
public class GuiSpotLightBeamProperties extends ContainerScreen<ContainerSpotLight> implements ISlider
{
    ...
    public GuiSpotLightBeamProperties(PlayerInventory playerInventory, TileEntitySpotLight tileEntity, World world, Container spotlightContainer)
    {
